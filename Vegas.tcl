...
set outfile_cwnd_upper_flow [open  "outputs/Vegas_cwnd_upper_flow.xg"  w]
set outfile_cwnd_lower_flow [open  "outputs/Vegas_cwnd_lower_flow.xg"  w]
set outfile_goodput_upper_flow [open  "outputs/Vegas_goodput_upper_flow.xg"  w]
set outfile_goodput_lower_flow [open  "outputs/Vegas_goodput_lower_flow.xg"  w]
set outfile_packetLoss_upper_flow [open  "outputs/Vegas_packetLoss_upper_flow.xg"  w]
set outfile_packetLoss_lower_flow [open  "outputs/Vegas_packetLoss_lower_flow.xg"  w]
set outfile_rtt_upper_flow [open  "outputs/Vegas_rtt_upper_flow.xg"  w]
set outfile_rtt_lower_flow [open  "outputs/Vegas_rtt_lower_flow.xg"  w]
