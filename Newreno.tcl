...
set outfile_cwnd_upper_flow [open  "outputs/Newreno_cwnd_upper_flow.xg"  w]
set outfile_cwnd_lower_flow [open  "outputs/Newreno_cwnd_lower_flow.xg"  w]
set outfile_goodput_upper_flow [open  "outputs/Newreno_goodput_upper_flow.xg"  w]
set outfile_goodput_lower_flow [open  "outputs/Newreno_goodput_lower_flow.xg"  w]
set outfile_packetLoss_upper_flow [open  "outputs/Newreno_packetLoss_upper_flow.xg"  w]
set outfile_packetLoss_lower_flow [open  "outputs/Newreno_packetLoss_lower_flow.xg"  w]
set outfile_rtt_upper_flow [open  "outputs/Newreno_rtt_upper_flow.xg"  w]
set outfile_rtt_lower_flow [open  "outputs/Newreno_rtt_lower_flow.xg"  w]
